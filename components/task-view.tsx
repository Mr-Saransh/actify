...
export function TaskView({ task }: TaskViewProps) {
    ...
    return (
        <Card className="w-full border-red-600 border-2 shadow-[0_0_15px_rgba(220,38,38,0.2)] bg-black relative overflow-hidden">
            {/* Header / Title */}
            ...
            <CardContent className="p-0">
                <div className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-widest">Required Output</h3>
                        <p className="text-lg md:text-xl font-mono text-zinc-300 leading-relaxed border-l-4 border-red-900 pl-4">
                    ...
                    <div className="bg-zinc-900/50 p-4 border border-zinc-800 rounded">
                        <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-3">Proof Requirements</h4>
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 text-zinc-400">
                                <div className="h-4 w-4 border border-zinc-600 rounded-sm flex items-center justify-center">
                                    <div className="h-2 w-2 bg-zinc-800" />
                                </div>
                                <span className="text-sm font-mono">Valid content URL (Image/Link)</span>
                            </div>
                            <div className="flex items-center gap-3 text-zinc-400">
                                <div className="h-4 w-4 border border-zinc-600 rounded-sm flex items-center justify-center">
                                    <div className="h-2 w-2 bg-zinc-800" />
                                </div>
                                <span className="text-sm font-mono">Detailed logic explanation</span>
                            </div>
                            <div className="flex items-center gap-3 text-zinc-400">
                                <div className="h-4 w-4 border border-zinc-600 rounded-sm flex items-center justify-center">
                                    <div className="h-2 w-2 bg-zinc-800" />
                                </div>
                                <span className="text-sm font-mono">No hesitation detected</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center pt-4">
                        {(task.state === "ACTIVE" || task.state === "REJECTED") && (
                            <div className="w-full max-w-md space-y-4 flex flex-col items-center">
                                {task.state === "REJECTED" && (
                                    <div className="bg-red-950/50 border border-red-500/50 p-4 rounded flex items-center gap-3 mb-4 w-full text-left">
                                        <AlertCircle className="text-red-500 h-6 w-6 shrink-0" />
                                        <div>
                                            <p className="font-bold text-red-500 uppercase">Submission Rejected</p>
                                            <p className="text-xs text-red-300">Proof was insufficient. Try again immediately.</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <p className="text-center text-xs text-zinc-600 uppercase tracking-widest">
                        ...
                        {isCompleted && (
                            <div className="w-full flex flex-col items-center gap-4 py-4">
                                <div className="text-green-500 font-bold uppercase tracking-widest flex items-center gap-2 text-xl border-2 border-green-500 px-6 py-2 rounded">
